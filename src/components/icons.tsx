...
export const CategoryIcons: { [key: string]: React.ComponentType<{ className?: string }> } = {
  ...
  'animalerie': Dog,
  'bagages-sacs-etuis': Briefcase,
  'bijoux-lunettes-montres': Gem,
  'bricolage-quincaillerie': Wrench,
  ...
  'hygiene-perso-menage': SprayCan,
  'instrument-equipement-de-test': TestTube,
  'lumiere-eclairage': Lightbulb,
