...
const formSchema = z.object({
  ...
  bannerImageUrl: z.string().url("Veuillez entrer une URL valide.").optional().or(z.literal('')),
});
...
export function CategoryForm({ open, onOpenChange, category, allCategories }: CategoryFormProps) {
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Cette image s'affichera en haut de la page de cette catégorie.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
  ...
  <change>
    <file>src/components/product-listing.tsx</file>
    <content><![CDATA[
"use client";
